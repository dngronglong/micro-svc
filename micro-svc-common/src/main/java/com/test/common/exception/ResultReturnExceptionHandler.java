...
public class ResultReturnExceptionHandler {
    ...
    public Result handle401(ShiroException e) {
        ...
        return Result.error(FwWebError.UNAUTHORIZED);
    }
    ...
    public Result handleMultipart(Throwable t) {
        ...
        return Result.error(FwWebError.COMMON_UPLOAD_FILE_SIZE_MAX);
    }
    ...
    public Result handleJsonConv(Throwable t) {
        log.error(t.getMessage(), t);
        return Result.error(FwWebError.COMMON_PARAMS_NOT_EXIST);
    }
    ...
    public Result handleRRException(Throwable e) {
        log.error(e.getMessage(), e);
        return Result.error(e.getMessage(), FwWebError.COMMON_PARAMS_ERR.code);
    }
